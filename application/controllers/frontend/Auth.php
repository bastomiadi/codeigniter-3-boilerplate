...
class Auth extends CI_Controller {
    ...
    public function login() {
        ...
        // Load login view
        $this->load->view('frontend/auth/login', $data); // Adjust view path as per your structure
    }
    ...
    public function register() {
        ...
        // Load register view
        $this->load->view('frontend/auth/register'); // Adjust view path as per your structure
    }
